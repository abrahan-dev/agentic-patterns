...
} from "../orchestration/specification-reviewer.ts";
import type { CommandRunner } from "../ui/tmux.ts";
...
function renderReview({ specification, state }: SpecificationReviewContext): void {
  const tokens = new Intl.NumberFormat("en-US").format(
    state.tokenTotals.team.totalTokens,
  );
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log(
    `HUMAN REVIEW  ·  TURN ${state.turns}/${state.maxTurns}  ·  TEAM TOKENS ${tokens}`,
  );
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
